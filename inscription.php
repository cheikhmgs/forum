...
<html>
   ...
   <body>
      <a href=" connexion.php" class="lien"><h1>connexion</h1></a>
      <div class=" form-wrap">
         <h2>Inscription</h2>
         <br /><br />
         <form method="POST" action="">
            <table>
               ...
               <tr>
                  ...
                  <td>
                     <input type="password" placeholder="Votre mot de passe" id="mdp" name="mdp"value="" />
                  </td>
               </tr>
               <tr>
                  <td align="right">
             ...
             <input type="submit" name="forminscription" value="Je m'inscris"  class="ab" />
         </form>
         </div>       
         <?php
          if(isset($erreur)){
